...
Devices with serial number from SP250357 are only compatible with firmware versions 1.3.26 and upper. This is due to internal i2c address change on a component. Firmware versions 1.3.26 and upper remain compatible with older devices.
